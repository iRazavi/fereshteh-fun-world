...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-purple-100 via-pink-100 to-blue-100 py-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-6 md:mb-0">
            <Baby className="h-8 w-8 text-purple-500 mr-2" />
          ...
          <div className="text-center md:text-right text-gray-700 mb-6 md:mb-0">
            <p className="text-purple-600 font-semibold">مکانی آرام برای کودکان شما</p>
